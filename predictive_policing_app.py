...
def load_trend_data():
    ...
    data = {
        ...
        'Sophisticated Attacks': [34, 38, 45, 52, 61, 72, 85, 98, 112, 128, 145, 164, 185, 210, 238, 270],
        'Ransomware': [78, 89, 105, 125, 145, 168, 192, 218, 246, 276, 308, 343, 380, 420, 462, 508],
        'APT/Espionage': [28, 35, 42, 52, 64, 78, 95, 115, 138, 164, 195, 231, 272, 318, 370, 428],
        'Supply Chain': [12, 15, 18, 22, 28, 35, 43, 52, 62, 74, 88, 105, 125, 148, 175, 207]
    }
